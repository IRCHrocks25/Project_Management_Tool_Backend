...
export declare class TasksController {
    ...
    findOne(id: string): Promise<{
        ...
        dueDateMoves: import("./entities/task-due-date-move.entity").TaskDueDateMove[];
        id: string;
        title: string;
        description: string;
        ...
        movedDueDateUpdatedBy: import("../users/entities/user.entity").User;
        isCompleted: boolean;
        fileUrl: string;
    ...
    updateMovedDueDate(id: string, body: {
