// Script to add Rapid Prospect to users_role_enum in PostgreSQL
// Run with: node scripts/add-rapid-prospect-user-role.js

const { Client } = require('pg');
const path = require('path');
require('dotenv').config({ path: path.join(__dirname, '../.env') });

async function addRapidProspectUserRole() {
  ...
  try {
    ...
    const enumTypeName = 'users_role_enum';
